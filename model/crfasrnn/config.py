...
C.dataset_path = "/Users/philchen/Road_Seg_CIL/cil-road-segmentation-2019/cil-road-segmentation-2019"
...
C.momentum = 0.9
C.weight_decay = 5e-4
C.batch_size = 1   #default=16
C.nepochs = 10  #defualt=80
C.niters_per_epoch = 100   #defualt=1000
