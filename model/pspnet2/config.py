...
# C.train_source = osp.join(C.dataset_path, "ottawa_training.txt")
C.eval_source = osp.join(C.dataset_path, "eval.txt")
C.test_source = osp.join(C.dataset_path, "test.txt")
C.edge_source = osp.join(C.dataset_path, "edges.txt")
C.midline_source = osp.join(C.dataset_path, "midlines.txt")
C.is_test = False
